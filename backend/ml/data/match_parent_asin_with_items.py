...
query_path = 'processed/generated_queries_train_non_insufficient.jsonl'
item_path = 'processed/items_for_embedding.jsonl'
out_path = 'processed/matched_parent_asin_items.jsonl'
...
with open(query_path, 'r', encoding='utf-8') as fin, open(out_path, 'w', encoding='utf-8') as fout:
    for line in fin:
        ...
        if parent_asin and parent_asin in dict_items:
            ...
            fout.write(json.dumps(matched, ensure_ascii=False) + '\\n')
            count += 1

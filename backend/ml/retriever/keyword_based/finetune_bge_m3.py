...
def main():
    ...
    output_dir = base_dir / 'model/retriever' / f'bge-m3-finetuned-{datetime.now().strftime("%Y%m%d-%H%M%S")}'
    ...
    print(f"   python ml/retriever/save_to_chromadb.py MODEL_PATH={output_dir}")
